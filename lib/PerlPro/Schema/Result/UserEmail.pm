...
=head1 TABLE: C<system.user_email>

=cut

__PACKAGE__->table("system.user_email");
...
=head2 id
  ...
  is_auto_increment: 1
  is_nullable: 0
  sequence: 'system.user_email_id_seq'
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:3RYknUnr9USUrrT/MWOZmQ
